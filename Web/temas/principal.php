...
<head>
  ...
  <link href="<?=Assests("/")?>assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  ...
  <link href="<?=Assests("/")?>assets/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="<?=Assests("/")?>assets/vendor/simple-datatables/style.css" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css">
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  <!-- Template Main CSS File -->
  <link href="<?=Assests("/")?>assets/css/style.css" rel="stylesheet">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="#" class="logo d-flex align-items-center">
        <img src="<?=Assests("/")?>assets/img/logo.png" alt="">
        <span class="d-none d-lg-block">Sistema Adm</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="<?=Assests("/")?>assets/img/profile-img.jpg" alt="Profile" class="rounded-circle">
...
<!-- End Footer -->
  ...
  <script src="<?=Assests("/")?>assets/vendor/quill/quill.js"></script>
